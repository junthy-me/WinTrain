...
## 8. 可选：Gemini 视频输入对照测试

- [ ] 8.1 （可选）使用 Gemini 视频输入接口，对 S1/S2 样本执行直传分析（≤ 20 秒）
- [ ] 8.2 （可选）记录 Gemini 的 schema 符合率、延迟、成本，与 qwen3.5-plus 结果对比
- [ ] 8.3 （可选）将对照结果记录至 `results/model_comparison.md`
